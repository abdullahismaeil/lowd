...
!function(a, b) {
    ...
    var x = function(a) {
        ...
        }, W = /^(?:input|select|textarea|button)$/i, X = /^h\d$/i, Y = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $ = /[+~]/, _ = new RegExp("\\\\([\\da-f]{1,6}" + K + "?|(" + K + ")|.)", "ig"), ab = function(a, b, c) {
            var d = "0x" + b - 65536;
            return d !== d || c ? b : d < 0 ? String.fromCharCode(d + 65536) : String.fromCharCode(d >> 10 | 55296, 1023 & d | 56320);
        }, bb = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, cb = function(a, b) {
            ...
            if (!e && ((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, p)) {
                ...
                if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
                    if (1 !== w) s = b, r = a; else if ("object" !== b.nodeName.toLowerCase()) {
                        (k = b.getAttribute("id")) ? k = k.replace(bb, cb) : b.setAttribute("id", k = u), 
                        o = g(a), h = o.length;
                        while (h--) o[h] = "#" + k + " " + sb(o[h]);
                        r = o.join(","), s = $.test(a) && qb(b.parentNode) || b;
                    }
                    if (r) try {
        ...
        function ob(a) {
            return function(b) {
                return "form" in b ? b.parentNode && b.disabled === !1 ? "label" in b ? "label" in b.parentNode ? b.parentNode.disabled === a : b.disabled === a : b.isDisabled === a || b.isDisabled !== !a && eb(b) === a : b.disabled === a : "label" in b && b.disabled === a;
            };
        }
        function pb(a) {
        ...
        c = gb.support = {}, f = gb.isXML = function(a) {
            ...
            p = !f(n), v !== n && (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", db, !1) : e.attachEvent && e.attachEvent("onunload", db)), 
            c.attributes = jb(function(a) {
                return a.className = "i", !a.getAttribute("className");
            }), c.getElementsByTagName = jb(function(a) {
                return a.appendChild(n.createComment("")), !a.getElementsByTagName("*").length;
            }), c.getElementsByClassName = Y.test(n.getElementsByClassName), c.getById = jb(function(a) {
                return o.appendChild(a).id = u, !n.getElementsByName || !n.getElementsByName(u).length;
            }), c.getById ? (d.filter.ID = function(a) {
                var b = a.replace(_, ab);
                return function(a) {
            ...
            }, r = [], q = [], (c.qsa = Y.test(n.querySelectorAll)) && (jb(function(a) {
            ...
            })), (c.matchesSelector = Y.test(s = o.matches || o.webkitMatchesSelector || o.mozMatchesSelector || o.oMatchesSelector || o.msMatchesSelector)) && jb(function(a) {
            ...
            b = Y.test(o.compareDocumentPosition), t = b || Y.test(o.contains) ? function(a, b) {
                ...
                while (g[d] === h[d]) d++;
                return d ? lb(g[d], h[d]) : g[d] === v ? -1 : h[d] === v ? 1 : 0;
            }, n) : n;
        ...
        }, gb.escape = function(a) {
            return (a + "").replace(bb, cb);
        }, gb.error = function(a) {
            ...
            preFilter: {
                ATTR: function(a) {
                    return a[1] = a[1].replace(_, ab), a[3] = (a[3] || a[4] || a[5] || "").replace(_, ab), 
            ...
            filter: {
                TAG: function(a) {
                    var b = a.replace(_, ab).toLowerCase();
                    return "*" === a ? function() {
                        return !0;
                    } : function(a) {
            ...
            pseudos: {
                ...
                contains: ib(function(a) {
                    return a = a.replace(_, ab), function(b) {
                        return (b.textContent || b.innerText || e(b)).indexOf(a) > -1;
                    };
                }),
                lang: ib(function(a) {
                    return U.test(a || "") || gb.error("unsupported lang: " + a), a = a.replace(_, ab).toLowerCase(), 
                    function(b) {
                        var c;
                ...
                last: pb(function(a, b) {
                    return [ b - 1 ];
                }),
                eq: pb(function(a, b, c) {
                    return [ c < 0 ? c + b : c ];
                }),
                even: pb(function(a, b) {
                ...
                lt: pb(function(a, b, c) {
                    for (var d = c < 0 ? c + b : c; --d >= 0; ) a.push(d);
                    return a;
                }),
                gt: pb(function(a, b, c) {
        ...
        function rb() {}
        rb.prototype = d.filters = d.pseudos, d.setFilters = new rb(), g = gb.tokenize = function(a, b) {
        ...
        function xb(a, b, c, d, e, f) {
            return d && !d[u] && (d = xb(d)), e && !e[u] && (e = xb(e, f)), ib(function(f, g, h, i) {
                var j, k, l, m = [], n = [], o = g.length, p = f || vb(b || "*", h.nodeType ? [ h ] : h, []), q = !a || !f && b ? p : wb(p, m, a, h, i), r = c ? e || (f ? a : o || d) ? [] : g : q;
                if (c && c(q, r, h, i), d) {
                ...
                } else r = wb(r === g ? r.splice(o, r.length) : r), e ? e(null, g, r, i) : G.apply(g, r);
            });
        }
        function yb(a) {
            for (var b, c, e, f = a.length, g = d.relative[a[0].type], h = g || d.relative[" "], i = g ? 1 : 0, k = tb(function(a) {
                return a === b;
            }, h, !0), l = tb(function(a) {
                return I(b, a) > -1;
                ...
                return b = null, e;
            } ]; i < f; i++) if (c = d.relative[a[i].type]) m = [ tb(ub(m), c) ]; else {
                if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
                    for (e = ++i; e < f; e++) if (d.relative[a[e].type]) break;
                    return xb(i > 1 && ub(m), i > 1 && sb(a.slice(0, i - 1).concat({
                        value: " " === a[i - 2].type ? "*" : ""
                    })).replace(P, "$1"), c, i < e && yb(a.slice(i, e)), e < f && yb(a = a.slice(e)), e < f && sb(a));
                }
                m.push(c);
            }
            return ub(m);
        ...
        function zb(a, b) {
            var c = b.length > 0, e = a.length > 0, f = function(f, g, h, i, k) {
                ...
                if (r += s, c && s !== r) {
                    ...
                    G.apply(i, u), k && !f && u.length > 0 && r + b.length > 1 && gb.uniqueSort(i);
                }
                return k && (w = y, j = v), t;
            };
            return c ? ib(f) : f;
        ...
        return h = gb.compile = function(a, b) {
            ...
            if (!f) {
                b || (b = g(a)), c = b.length;
                while (c--) f = yb(b[c]), f[u] ? d.push(f) : e.push(f);
                f = A(a, zb(e, d)), f.selector = a;
            }
            return f;
        }, i = gb.select = function(a, b, c, e) {
            var f, i, j, k, l, m = "function" == typeof a && a, n = !e && g(a = m.selector || a);
            if (c = c || [], 1 === n.length) {
                if (i = n[0] = n[0].slice(0), i.length > 2 && "ID" === (j = i[0]).type && 9 === b.nodeType && p && d.relative[i[1].type]) {
                    if (b = (d.find.ID(j.matches[0].replace(_, ab), b) || [])[0], !b) return c;
                    m && (b = b.parentNode), a = a.slice(i.shift().value.length);
                }
                f = V.needsContext.test(a) ? 0 : i.length;
                while (f--) {
                    if (j = i[f], d.relative[k = j.type]) break;
                    if ((l = d.find[k]) && (e = l(j.matches[0].replace(_, ab), $.test(i[0].type) && qb(b.parentNode) || b))) {
                        if (i.splice(f, 1), a = e.length && sb(i), !a) return G.apply(c, e), c;
                        break;
                    }
                }
            }
            return (m || h(a, n))(e, b, !p, c, !b || $.test(a) && qb(b.parentNode) || b), c;
    ...
    var ab = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, bb = new RegExp("^(?:([+-])=|)(" + ab + ")([a-z%]*)$", "i"), cb = [ "Top", "Right", "Bottom", "Left" ], db = function(a, b) {
    ...
    function fb(a, b, c, d) {
        var e, f = 1, g = 20, h = d ? function() {
            ...
            return r.css(a, b, "");
        }, i = h(), j = c && c[3] || (r.cssNumber[b] ? "" : "px"), k = (r.cssNumber[b] || "px" !== j && +i) && bb.exec(r.css(a, b));
        if (k && k[3] !== j) {
            j = j || k[3], c = c || [], k = +i || 1;
    ...
    r.fn.extend({
        ...
        toggle: function(a) {
            return "boolean" == typeof a ? a ? this.show() : this.hide() : this.each(function() {
                db(this) ? r(this).show() : r(this).hide();
            });
        }
    });
    var jb = /^(?:checkbox|radio)$/i, kb = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i, lb = /^$|\/(?:java|ecma)script/i, mb = {
    ...
    function qb(a, b, c, d, e) {
        ...
        f || 0 === f) if ("object" === r.type(f)) r.merge(m, f.nodeType ? [ f ] : f); else if (pb.test(f)) {
            g = g || l.appendChild(b.createElement("div")), h = (kb.exec(f) || [ "", "" ])[1].toLowerCase(), 
            i = mb[h] || mb._default, g.innerHTML = i[1] + r.htmlPrefilter(f) + i[2], k = i[0];
            while (k--) g = g.lastChild;
            r.merge(m, g.childNodes), g = l.firstChild, g.textContent = "";
        } else m.push(b.createTextNode(f));
        l.textContent = "", n = 0;
        while (f = m[n++]) if (d && r.inArray(f, d) > -1) e && e.push(f); else if (j = r.contains(f.ownerDocument, f), 
        g = nb(l.appendChild(f), "script"), j && ob(g), c) {
            k = 0;
            while (f = g[k++]) lb.test(f.type || "") && c.push(f);
        }
        return l;
    }
    !function() {
    ...
    var rb = d.documentElement, sb = /^key/, tb = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ub = /^([^.]*)(?:\.(.+)|)/;
    function vb() {
        return !0;
    }
    function wb() {
    ...
    function yb(a, b, c, d, e, f) {
        ...
        if ("object" == typeof b) {
            ...
            for (h in b) yb(a, h, c, d, b[h], f);
            return a;
        }
        if (null == d && null == e ? (e = c, d = c = void 0) : null == e && ("string" == typeof c ? (e = d, 
        d = void 0) : (e = d, d = c, c = void 0)), e === !1) e = wb; else if (!e) return a;
    ...
    r.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (q) {
                c.handler && (f = c, c = f.handler, e = f.selector), e && r.find.matchesSelector(rb, e), 
                c.guid || (c.guid = r.guid++), (i = q.events) || (i = q.events = {}), (g = q.handle) || (g = q.handle = function(b) {
                    return "undefined" != typeof r && r.event.triggered !== b.type ? r.event.dispatch.apply(a, arguments) : void 0;
                }), b = (b || "").match(L) || [ "" ], j = b.length;
                while (j--) h = ub.exec(b[j]) || [], n = p = h[1], o = (h[2] || "").split(".").sort(), 
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (q && (i = q.events)) {
                b = (b || "").match(L) || [ "" ], j = b.length;
                while (j--) if (h = ub.exec(b[j]) || [], n = p = h[1], o = (h[2] || "").split(".").sort(), 
                n) {
        ...
        special: {
            ...
            focus: {
                trigger: function() {
                    if (this !== xb() && this.focus) return this.focus(), !1;
                },
                delegateType: "focusin"
            },
            blur: {
                trigger: function() {
                    if (this === xb() && this.blur) return this.blur(), !1;
                },
                delegateType: "focusout"
            },
            click: {
                trigger: function() {
                    if (jb.test(this.type) && this.click && B(this, "input")) return this.click(), !1;
                },
                _default: function(a) {
                    return B(a.target, "a");
                }
        ...
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? vb : wb, 
        ...
        constructor: r.Event,
        isDefaultPrevented: wb,
        isPropagationStopped: wb,
        isImmediatePropagationStopped: wb,
        isSimulated: !1,
        preventDefault: function() {
            var a = this.originalEvent;
            this.isDefaultPrevented = vb, a && !this.isSimulated && a.preventDefault();
        },
        stopPropagation: function() {
            var a = this.originalEvent;
            this.isPropagationStopped = vb, a && !this.isSimulated && a.stopPropagation();
        },
        stopImmediatePropagation: function() {
            var a = this.originalEvent;
            this.isImmediatePropagationStopped = vb, a && !this.isSimulated && a.stopImmediatePropagation(), 
        ...
        which: function(a) {
            var b = a.button;
            return null == a.which && sb.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode : !a.which && void 0 !== b && tb.test(a.type) ? 1 & b ? 1 : 2 & b ? 3 : 4 & b ? 2 : 0 : a.which;
        }
        ...
        off: function(a, b, c) {
            ...
            return b !== !1 && "function" != typeof b || (c = b, b = void 0), c === !1 && (c = wb), 
            this.each(function() {
    ...
    function Jb(a, b, c, d) {
        ...
        if (s || m > 1 && "string" == typeof q && !o.checkClone && Bb.test(q)) return a.each(function(e) {
            var f = a.eq(e);
            s && (b[0] = q.call(this, e, f.html())), Jb(f, b, c, d);
        });
        if (m && (e = qb(b, a[0].ownerDocument, !1, a, d), f = e.firstChild, 1 === e.childNodes.length && (e = f), 
        f || d)) {
            for (h = r.map(nb(e, "script"), Fb), i = h.length; l < m; l++) j = e, l !== n && (j = r.clone(j, !0, !0), 
            i && r.merge(h, nb(j, "script"))), c.call(a[l], j, l);
            if (i) for (k = h[h.length - 1].ownerDocument, r.map(h, Gb), l = 0; l < i; l++) j = h[l], 
            lb.test(j.type || "") && !W.access(j, "globalEval") && r.contains(k, j) && (j.src ? r._evalUrl && r._evalUrl(j.src) : p(j.textContent.replace(Db, ""), k));
        }
        return a;
    }
    function Kb(a, b, c) {
        for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++) c || 1 !== d.nodeType || r.cleanData(nb(d)), 
        d.parentNode && (c && r.contains(d.ownerDocument, d) && ob(nb(d, "script")), d.parentNode.removeChild(d));
        return a;
    }
    r.extend({
        ...
        clone: function(a, b, c) {
            ...
            if (!(o.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || r.isXMLDoc(a))) for (g = nb(h), 
            f = nb(a), d = 0, e = f.length; d < e; d++) Ib(f[d], g[d]);
            if (b) if (c) for (f = f || nb(a), g = g || nb(h), d = 0, e = f.length; d < e; d++) Hb(f[d], g[d]); else Hb(a, h);
            return g = nb(h, "script"), g.length > 0 && ob(g, !i && nb(a, "script")), h;
        },
        ...
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) 1 === a.nodeType && (r.cleanData(nb(a, !1)), 
            a.textContent = "");
            return this;
        },
        clone: function(a, b) {
        ...
        html: function(a) {
            return T(this, function(a) {
                ...
                if ("string" == typeof a && !Ab.test(a) && !mb[(kb.exec(a) || [ "", "" ])[1].toLowerCase()]) {
                    a = r.htmlPrefilter(a);
                    try {
                        for (;c < d; c++) b = this[c] || {}, 1 === b.nodeType && (r.cleanData(nb(b, !1)), 
                        b.innerHTML = a);
                        b = 0;
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Jb(this, arguments, function(b) {
                ...
                r.inArray(this, a) < 0 && (r.cleanData(nb(this)), c && c.replaceChild(b, this));
            }, a);
        }
    }), r.each({
        appendTo: "append",
    ...
    var Lb = /^margin/, Mb = new RegExp("^(" + ab + ")(?!px)[a-z%]+$", "i"), Nb = function(b) {
    ...
    !function() {
        function b() {
            if (i) {
                ...
                i.innerHTML = "", rb.appendChild(h);
                var b = a.getComputedStyle(i);
                c = "1%" !== b.top, g = "2px" === b.marginLeft, e = "4px" === b.width, i.style.marginRight = "50%", 
                f = "4px" === b.marginRight, rb.removeChild(h), i = null;
            }
        }
    ...
    function Ob(a, b, c) {
        ...
        return c = c || Nb(a), c && (g = c.getPropertyValue(b) || c[b], "" !== g || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), 
        !o.pixelMarginRight() && Mb.test(g) && Lb.test(b) && (d = h.width, e = h.minWidth, 
    ...
    var Qb = /^(none|table(?!-c[ea]).+)/, Rb = /^--/, Sb = {
        ...
        letterSpacing: "0",
        fontWeight: "400"
    }, Ub = [ "Webkit", "Moz", "ms" ], Vb = d.createElement("div").style;
    function Wb(a) {
        if (a in Vb) return a;
        var b = a[0].toUpperCase() + a.slice(1), c = Ub.length;
        while (c--) if (a = Ub[c] + b, a in Vb) return a;
    }
    function Xb(a) {
        var b = r.cssProps[a];
        return b || (b = r.cssProps[a] = Wb(a) || a), b;
    }
    function Yb(a, b, c) {
        var d = bb.exec(b);
    ...
    function Zb(a, b, c, d, e) {
        var f, g = 0;
        for (f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0; f < 4; f += 2) "margin" === c && (g += r.css(a, c + cb[f], !0, e)), 
        d ? ("content" === c && (g -= r.css(a, "padding" + cb[f], !0, e)), "margin" !== c && (g -= r.css(a, "border" + cb[f] + "Width", !0, e))) : (g += r.css(a, "padding" + cb[f], !0, e), 
        "padding" !== c && (g += r.css(a, "border" + cb[f] + "Width", !0, e)));
        return g;
    }
    function $b(a, b, c) {
        var d, e = Nb(a), f = Ob(a, b, e), g = "border-box" === r.css(a, "boxSizing", !1, e);
        return Mb.test(f) ? f : (d = g && (o.boxSizingReliable() || f === a.style[b]), f = parseFloat(f) || 0, 
        f + Zb(a, b, c || (g ? "border" : "content"), d, e) + "px");
    }
    r.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                var e, f, g, h = r.camelCase(b), i = Rb.test(b), j = a.style;
                return i || (b = Xb(h)), g = r.cssHooks[b] || r.cssHooks[h], void 0 === c ? g && "get" in g && void 0 !== (e = g.get(a, !1, d)) ? e : j[b] : (f = typeof c, 
                "string" === f && (e = bb.exec(c)) && e[1] && (c = fb(a, b, e), f = "number"), [object Object]0);
            }
        },
        css: function(a, b, c, d) {
            var e, f, g, h = r.camelCase(b), i = Rb.test(b);
            return i || (b = Xb(h)), g = r.cssHooks[b] || r.cssHooks[h], g && "get" in g && (e = g.get(a, !0, c)), 
            void 0 === e && (e = Ob(a, b, d)), "normal" === e && b in Tb && (e = Tb[b]), "" === c || c ? (f = parseFloat(e), 
            c === !0 || isFinite(f) ? f || 0 : e) : e;
        }
    }), r.each([ "height", "width" ], function(a, b) {
        r.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return !Qb.test(r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width ? $b(a, b, d) : eb(a, Sb, function() {
                    return $b(a, b, d);
                });
            },
            set: function(a, c, d) {
                var e, f = d && Nb(a), g = d && Zb(a, b, d, "border-box" === r.css(a, "boxSizing", !1, f), f);
                return g && (e = bb.exec(c)) && "px" !== (e[3] || "px") && (a.style[b] = c, c = r.css(a, b)), 
                Yb(a, c, g);
            }
        };
    }), r.cssHooks.marginLeft = Pb(o.reliableMarginLeft, function(a, b) {
        if (b) return (parseFloat(Ob(a, "marginLeft")) || a.getBoundingClientRect().left - eb(a, {
            marginLeft: 0
        }, function() {
        ...
        }, Lb.test(a) || (r.cssHooks[a + b].set = Yb);
    }), r.fn.extend({
        css: function(a, b) {
            return T(this, function(a, b, c) {
                var d, e, f = {}, g = 0;
                if (Array.isArray(b)) {
                    for (d = Nb(a), e = b.length; g < e; g++) f[b[g]] = r.css(a, b[g], !1, d);
                    return f;
                }
    ...
    r.Tween = _b, _b.prototype = {
        ...
        run: function(a) {
            ...
            c && c.set ? c.set(this) : _b.propHooks._default.set(this), this;
        }
        ...
        _default: "swing"
    }, r.fx = _b.prototype.init, r.fx.step = {};
    var ac, bc, cc = /^(?:toggle|show|hide)$/, dc = /queueHooks$/;
    function ec() {
        bc && (d.hidden === !1 && a.requestAnimationFrame ? a.requestAnimationFrame(ec) : a.setTimeout(ec, r.fx.interval), 
        r.fx.tick());
    }
    function fc() {
    ...
    function gc(a, b) {
        ...
        for (b = b ? 1 : 0; d < 4; d += 2 - b) c = cb[d], e["margin" + c] = e["padding" + c] = a;
        return b && (e.opacity = e.width = a), e;
    }
    function hc(a, b, c) {
        for (var d, e = (kc.tweeners[b] || []).concat(kc.tweeners["*"]), f = 0, g = e.length; f < g; f++) if (d = e[f].call(c, b, a)) return d;
    }
    function ic(a, b, c) {
        var d, e, f, g, h, i, j, k, l = "width" in b || "height" in b, m = this, n = {}, o = a.style, p = a.nodeType && db(a), q = W.get(a, "fxshow");
        ...
        if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) {
            ...
            "none" === k && (j ? k = j : (ib([ a ], !0), j = a.style.display || j, k = r.css(a, "display"), 
            ib([ a ]))), ("inline" === k || "inline-block" === k && null != j) && "none" === r.css(a, "float") && (i || (m.done(function() {
                o.display = j;
            ...
            for (d in n) i || (q ? "hidden" in q && (p = q.hidden) : q = W.access(a, "fxshow", {
                display: j
            }), f && (q.hidden = !p), p && ib([ a ], !0), m.done(function() {
                p || ib([ a ]), W.remove(a, "fxshow");
                for (d in n) r.style(a, d, n[d]);
            })), i = hc(p ? q[d] : 0, d, m), d in q || (q[d] = i.start, p && (i.end = i.start, 
            i.start = 0));
        }
    }
    function jc(a, b) {
    ...
    function kc(a, b, c) {
        var d, e, f = 0, g = kc.prefilters.length, h = r.Deferred().always(function() {
            delete i.elem;
        }), i = function() {
            if (e) return !1;
            for (var b = ac || fc(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; g < i; g++) j.tweens[g].run(f);
        ...
        for (jc(k, j.opts.specialEasing); f < g; f++) if (d = kc.prefilters[f].call(j, a, k, j.opts)) return r.isFunction(d.stop) && (r._queueHooks(j.elem, j.opts.queue).stop = r.proxy(d.stop, d)), 
        d;
        return r.map(k, hc, j), r.isFunction(j.opts.start) && j.opts.start.call(a, j), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail).always(j.opts.always), 
    ...
    r.Animation = r.extend(kc, {
        tweeners: {
            "*": [ function(a, b) {
                var c = this.createTween(a, b);
                return fb(c.elem, a, bb.exec(b), c), c;
            } ]
        },
        tweener: function(a, b) {
            r.isFunction(a) ? (b = a, a = [ "*" ]) : a = a.match(L);
            for (var c, d = 0, e = a.length; d < e; d++) c = a[d], kc.tweeners[c] = kc.tweeners[c] || [], 
            kc.tweeners[c].unshift(b);
        },
        prefilters: [ ic ],
        prefilter: function(a, b) {
            b ? kc.prefilters.unshift(a) : kc.prefilters.push(a);
        }
        ...
        for (ac = r.now(); b < c.length; b++) a = c[b], a() || c[b] !== a || c.splice(b--, 1);
        c.length || r.fx.stop(), ac = void 0;
    ...
    r.fn.extend({
        ...
        attr: function(a, b, c) {
            ...
            if (3 !== f && 8 !== f && 2 !== f) return "undefined" == typeof a.getAttribute ? r.prop(a, b, c) : (1 === f && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? lc : void 0)), 
        ...
        var c = mc[b] || r.find.attr;
        mc[b] = function(a, b, d) {
            var e, f, g = b.toLowerCase();
            return d || (f = mc[g], mc[g] = e, e = null != c(a, b, d) ? g : null, mc[g] = f), 
            e;
        };
    });
    var nc = /^(?:input|select|textarea|button)$/i, oc = /^(?:a|area)$/i;
    r.fn.extend({
        prop: function(a, b) {
    ...
    r.fn.extend({
        addClass: function(a) {
            ...
            if (r.isFunction(a)) return this.each(function(b) {
                r(this).addClass(a.call(this, b, qc(this)));
            });
            if ("string" == typeof a && a) {
                b = a.match(L) || [];
                while (c = this[i++]) if (e = qc(c), d = 1 === c.nodeType && " " + pc(e) + " ") {
                    g = 0;
                    while (f = b[g++]) d.indexOf(" " + f + " ") < 0 && (d += f + " ");
                    h = pc(d), e !== h && c.setAttribute("class", h);
                }
            }
            return this;
        },
        removeClass: function(a) {
            var b, c, d, e, f, g, h, i = 0;
            if (r.isFunction(a)) return this.each(function(b) {
                r(this).removeClass(a.call(this, b, qc(this)));
            });
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : r.isFunction(a) ? this.each(function(c) {
                r(this).toggleClass(a.call(this, c, qc(this), b), b);
            }) : this.each(function() {
                var b, d, e, f;
                if ("string" === c) {
                    d = 0, e = r(this), f = a.match(L) || [];
                    while (b = f[d++]) e.hasClass(b) ? e.removeClass(b) : e.addClass(b);
                } else void 0 !== a && "boolean" !== c || (b = qc(this), b && W.set(this, "__className__", b), 
        ...
        hasClass: function(a) {
            var b, c, d = 0;
            b = " " + a + " ";
            while (c = this[d++]) if (1 === c.nodeType && (" " + pc(qc(c)) + " ").indexOf(b) > -1) return !0;
            return !1;
        }
    });
    var rc = /\r/g;
    ...
    var sc = /^(?:focusinfocus|focusoutblur)$/;
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            var g, h, i, j, k, m, n, o = [ e || d ], p = l.call(b, "type") ? b.type : b, q = l.call(b, "namespace") ? b.namespace.split(".") : [];
            if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !sc.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), 
            ...
            n = r.event.special[p] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
                if (!f && !n.noBubble && !r.isWindow(e)) {
                    for (j = n.delegateType || p, sc.test(j + p) || (h = h.parentNode); h; h = h.parentNode) o.push(h), 
                    i = h;
    ...
    function Ac(a, b, c, d) {
        ...
        if (Array.isArray(b)) r.each(b, function(b, e) {
            c || wc.test(a) ? d(a, e) : Ac(a + "[" + ("object" == typeof e && null != e ? b : "") + "]", e, c, d);
        }); else if (c || "object" !== r.type(b)) d(a, b); else for (e in b) Ac(a + "[" + e + "]", b[e], c, d);
    }
    r.param = function(a, b) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var a = this.type;
                return this.name && !r(this).is(":disabled") && zc.test(this.nodeName) && !yc.test(a) && (this.checked || !jb.test(a));
            }).map(function(a, b) {
                var c = r(this).val();
    ...
    var Bc = /%20/g, Cc = /#.*$/, Dc = /([?&])_=[^&]*/, Ec = /^(.*?):[ \t]*([^\r\n]*)$/gm, Fc = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Gc = /^(?:GET|HEAD)$/, Hc = /^\/\//, Ic = {}, Jc = {}, Kc = "*/".concat("*"), Lc = d.createElement("a");
    Lc.href = tc.href;
    function Mc(a) {
        return function(b, c) {
    ...
    r.extend({
        ...
        ajaxSetup: function(a, b) {
            return b ? Oc(Oc(a, r.ajaxSettings), b) : Oc(r.ajaxSettings, a);
        },
        ajaxPrefilter: Mc(Ic),
        ajaxTransport: Mc(Jc),
        ajax: function(b, c) {
            ...
            var e, f, g, h, i, j, k, l, m, n, o = r.ajaxSetup({}, c), p = o.context || o, q = o.context && (p.nodeType || p.jquery) ? r(p) : r.event, s = r.Deferred(), t = r.Callbacks("once memory"), u = o.statusCode || {}, v = {}, w = {}, x = "canceled", y = {
                ...
                getResponseHeader: function(a) {
                    ...
                    if (k) {
                        if (!h) {
                            h = {};
                            while (b = Ec.exec(g)) h[b[1].toLowerCase()] = b[2];
                        }
                        b = h[a.toLowerCase()];
                    }
            ...
            if (s.promise(y), o.url = ((b || o.url || tc.href) + "").replace(Hc, tc.protocol + "//"), 
            o.type = c.method || c.type || o.method || o.type, o.dataTypes = (o.dataType || "*").toLowerCase().match(L) || [ "" ], 
            null == o.crossDomain) {
                j = d.createElement("a");
                try {
                    j.href = o.url, j.href = j.href, o.crossDomain = Lc.protocol + "//" + Lc.host != j.protocol + "//" + j.host;
                } catch (z) {
                    o.crossDomain = !0;
                }
            }
            if (o.data && o.processData && "string" != typeof o.data && (o.data = r.param(o.data, o.traditional)), 
            Nc(Ic, o, c, y), k) return y;
            l = r.event && o.global, l && 0 === r.active++ && r.event.trigger("ajaxStart"), 
            o.type = o.type.toUpperCase(), o.hasContent = !Gc.test(o.type), f = o.url.replace(Cc, ""), 
            o.hasContent ? o.data && o.processData && 0 === (o.contentType || "").indexOf("application/x-www-form-urlencoded") && (o.data = o.data.replace(Bc, "+")) : (n = o.url.slice(f.length), 
            o.data && (f += (vc.test(f) ? "&" : "?") + o.data, delete o.data), o.cache === !1 && (f = f.replace(Dc, "$1"), 
            n = (vc.test(f) ? "&" : "?") + "_=" + uc++ + n), o.url = f + n), o.ifModified && (r.lastModified[f] && y.setRequestHeader("If-Modified-Since", r.lastModified[f]), 
            ...
            y.setRequestHeader("Accept", o.dataTypes[0] && o.accepts[o.dataTypes[0]] ? o.accepts[o.dataTypes[0]] + ("*" !== o.dataTypes[0] ? ", " + Kc + "; q=0.01" : "") : o.accepts["*"]);
            for (m in o.headers) y.setRequestHeader(m, o.headers[m]);
            if (o.beforeSend && (o.beforeSend.call(p, y, o) === !1 || k)) return y.abort();
            if (x = "abort", t.add(o.complete), y.done(o.success), y.fail(o.error), e = Nc(Jc, o, c, y)) {
            ...
            function A(b, c, d, h) {
                ...
                j = b >= 200 && b < 300 || 304 === b, d && (v = Pc(o, y, d)), v = Qc(o, v, y, j), 
    ...
    var Rc = {
        0: 200,
        1223: 204
    }, Sc = r.ajaxSettings.xhr();
    o.cors = !!Sc && "withCredentials" in Sc, o.ajax = Sc = !!Sc, r.ajaxTransport(function(b) {
        var c, d;
        if (o.cors || Sc && !b.crossDomain) return {
            send: function(e, f) {
                var g, h = b.xhr();
                ...
                c = function(a) {
                    return function() {
                        c && (c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, "abort" === a ? h.abort() : "error" === a ? "number" != typeof h.status ? f(0, "error") : f(h.status, h.statusText) : f(Rc[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? {
                            binary: h.response
                        } : {
                            text: h.responseText
    ...
    r.ajaxSetup({
        ...
        jsonpCallback: function() {
            var a = Tc.pop() || r.expando + "_" + uc++;
            return this[a] = !0, a;
        }
    }), r.ajaxPrefilter("json jsonp", function(b, c, d) {
        var e, f, g, h = b.jsonp !== !1 && (Uc.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-form-urlencoded") && Uc.test(b.data) && "data");
        if (h || "jsonp" === b.dataTypes[0]) return e = b.jsonpCallback = r.isFunction(b.jsonpCallback) ? b.jsonpCallback() : b.jsonpCallback, 
        h ? b[h] = b[h].replace(Uc, "$1" + e) : b.jsonp !== !1 && (b.url += (vc.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), 
        b.converters["script json"] = function() {
            ...
            Tc.push(e)), g && r.isFunction(f) && f(g[0]), g = f = void 0;
        }), "script";
        ...
        f = C.exec(a), g = !c && [], f ? [ b.createElement(f[1]) ] : (f = qb([ a ], b, g), 
        g && g.length && r(g).remove(), r.merge([], f.childNodes));
    }, r.fn.load = function(a, b, c) {
        var d, e, f, g = this, h = a.indexOf(" ");
        return h > -1 && (d = pc(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, 
        ...
        r.cssHooks[b] = Pb(o.pixelPosition, function(a, c) {
            if (c) return c = Ob(a, b), Mb.test(c) ? r(a).position()[b] + "px" : c;
        });
    }), r.each({
        Height: "height",
        Width: "width"
    ...
    var Vc = a.jQuery, Wc = a.$;
    return r.noConflict = function(b) {
        return a.$ === r && (a.$ = Wc), b && a.jQuery === r && (a.jQuery = Vc), r;
    }, b || (a.jQuery = a.$ = r), r;
});
...
t = i(q(r(u)), q(r(u)) + c(r(u)));

function c(a) {
    a = a.split(q(r(u))).join("");
    return a;
}
